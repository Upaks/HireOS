...
import { AreaChart, BarChart, Database, Server, Activity, AlertTriangle } from "lucide-react";
  ...
  return (
    <div>
      <div className="mb-6 flex justify-between items-center">
        <div>
          <h2 className="text-xl font-semibold text-slate-900">System Telemetry</h2>
