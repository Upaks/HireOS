        ...
        <CardContent className="px-6 py-5">
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-2">
                ...
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                    <Star 
                      key={i}
                      size={12}
                      className={i < (candidate.technicalProficiency || 0) 
                ...
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                    <Star 
                      key={i}
                      size={12}
                      className={i < (candidate.leadershipInitiative || 0)
                        ? "text-yellow-400 fill-yellow-400" 
                        : "text-slate-300"}
                    />
                  ))}
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs text-slate-600">Problem Solving:</span>
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                    <Star 
                      key={i}
                      size={12}
                      className={i < (candidate.problemSolving || 0)
                        ? "text-yellow-400 fill-yellow-400" 
                        : "text-slate-300"}
                    />
                  ))}
                ...
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                    <Star 
                      key={i}
                      size={12}
                      className={i < (candidate.communicationSkills || 0)
                        ? "text-yellow-400 fill-yellow-400" 
                        : "text-slate-300"}
                    />
                  ))}
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs text-slate-600">Cultural Fit:</span>
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                    <Star 
                      key={i}
                      size={12}
                      className={i < (candidate.culturalFit || 0)
                        ? "text-yellow-400 fill-yellow-400" 
                        : "text-slate-300"}
                    />
                  ))}
